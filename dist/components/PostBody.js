...
function BlockColumnList(props) {
  ...
  if (children?.length === 0)
    return null;
  return /* @__PURE__ */ jsx11("div", { className: cn7("w-full grid !my-0 gap-3", parseColumnClasses(children.length), className), children: children.map((col, index1) => {
    return /* @__PURE__ */ jsx11("div", { className: cn7("w-full flex flex-col gap-3"), children: col["children"].map((child, index2) => /* @__PURE__ */ jsx11(BlockRender, { block: child, level: 0, isInsideColumn: true }, index2)) }, index1);
  }) });
}
...
function BlockTable(props) {
  ...
  return /* @__PURE__ */ jsx28("div", { className: cn17(className, "w-full overflow-auto md:overflow-visible"), children: /* @__PURE__ */ jsxs15("table", { className: "table-auto", children: [
...
function IoIosArrowDown(props) {
  return /* @__PURE__ */ jsx33(
    "svg",
    {
      ...
      width: "1em",
      xmlns: "http://www.w3.org/2000/svg",
      children: /* @__PURE__ */ jsx33("path", { d: "M256 294.1L383 167c9.4-9.4 24.6-9.4 33.9 0s9.3 24.6 0 34L273 345c-9.1 9.1-23.7 9.3-33.1.7L95 201.1c-4.7-4.7-7-10.9-7-17s2.3-12.3 7-17c9.4-9.4 24.6-9.4 33.9 0l127.1 127z" })
    }
  );
}
...
function PostBody(props) {
  ...
  return /* @__PURE__ */ jsxs18("div", { className: cn21("m2it-prose", postBodyContainerClass, className), children: [
    /* @__PURE__ */ jsx35(
      PostToc,
      {
    ...
    !!contentBlocks.length && contentBlocks.map((block) => /* @__PURE__ */ jsx35(
      BlockRender,
      {
    ...
    !contentBlocks.length && /* @__PURE__ */ jsx35("p", { children: props.noContentMessage || "B\xE0i vi\u1EBFt n\xE0y ch\u01B0a c\xF3 n\u1ED9i dung." })
  ] });
}
export {
  PostBody as default,

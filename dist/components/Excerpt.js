...
function Excerpt(props) {
  if (!props.excerpt || !props.excerpt.length) {
    if (props.defaultExcerpt)
      return /* @__PURE__ */ jsx23("span", { children: props.defaultExcerpt });
    return "Undefined excerpt";
  }
  return /* @__PURE__ */ jsx23("span", { children: props.excerpt.map((richText, index) => /* @__PURE__ */ jsx23(BlockRichText, { richText, ignore: ["hyperlink"] }, index)) });
}
export {
  Excerpt as default
};

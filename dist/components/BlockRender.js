...
function BlockCode(props) {
  ...
  return /* @__PURE__ */ jsxs13("div", { className: cn16(className, "group"), children: [
    /* @__PURE__ */ jsxs13("div", { className: `language-${formatCodeLang(language)} syntax-highlighter relative text-[18px]`, children: [
      /* @__PURE__ */ jsx26(
        SyntaxHighlighter,
        {
      ...
      /* @__PURE__ */ jsx26(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx26(CopyToClipboard, { text: getJoinedRichText(block?.code?.rich_text), onCopy: onSuccess, children: /* @__PURE__ */ jsxs13("button", { children: [
            !copied && /* @__PURE__ */ jsx26(RxCopy, { className: "text-lg text-slate-300 hover:text-slate-600" }),

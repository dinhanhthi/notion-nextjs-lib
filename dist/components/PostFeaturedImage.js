...
var PostFeaturedImage_exports = {};
__export(PostFeaturedImage_exports, {
  default: () => PostFeaturedImage
});
module.exports = __toCommonJS(PostFeaturedImage_exports);
...
function PostFeaturedImage(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "relative flex h-full w-full items-center overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    ImageComponent,
    {
      defaultImage: props.defaultImage,
      image: featuredImage,
      alt: `H\xECnh \u0111\u1EA1i di\u1EC7n cho b\xE0i vi\u1EBFt "${title}"`,
      className: (0, import_classnames.default)("object-cover", props.className),
      imageProps: {
        fill: true
      }
    }

...
function BlockTable(props) {
  ...
  return /* @__PURE__ */ jsx26("div", { className: cn16(className, "w-full overflow-auto md:overflow-visible"), children: /* @__PURE__ */ jsxs14("table", { className: "table-auto", children: [

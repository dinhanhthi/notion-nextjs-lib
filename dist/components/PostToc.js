        ...
        children: [
          ...
          /* @__PURE__ */ jsx24(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx24(CopyToClipboard, { text: getJoinedRichText(block?.code?.rich_text), onCopy: onSuccess, children: /* @__PURE__ */ jsxs13("button", { children: [
...
function BlockEquation(props) {
  const { block, className } = props;
  return /* @__PURE__ */ jsx25("div", { className: cn15(className, "text-center overflow-auto m2it-scrollbar m2it-scrollbar-small"), children: /* @__PURE__ */ jsx25(
    Katex,
    {
...
function BlockTable(props) {
  ...
  return /* @__PURE__ */ jsx26("div", { className: cn16(className, "w-full overflow-auto md:overflow-visible"), children: /* @__PURE__ */ jsxs14("table", { className: "table-auto my-0", children: [
    block?.table?.has_column_header && /* @__PURE__ */ jsx26("thead", { children: trBlock({
...
function BlockText(props) {
  ...
  if (props.richText.plain_text.includes("\n")) {
    ...
    return /* @__PURE__ */ jsx31(Fragment6, { children: lines.map((line, index) => /* @__PURE__ */ jsxs16("span", { children: [
      line,
...
function IoIosArrowDown(props) {
  return /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      width: "1em",
      xmlns: "http://www.w3.org/2000/svg",
      children: /* @__PURE__ */ jsx("path", { d: "M256 294.1L383 167c9.4-9.4 24.6-9.4 33.9 0s9.3 24.6 0 34L273 345c-9.1 9.1-23.7 9.3-33.1.7L95 201.1c-4.7-4.7-7-10.9-7-17s2.3-12.3 7-17c9.4-9.4 24.6-9.4 33.9 0l127.1 127z" })
    }
  );
}
            ...
            children: headingBlocks.map((block) => {
              ...
              return /* @__PURE__ */ jsxs17(
                "a",
                {
                  ...
                  children: [
                    block.type === "heading_2" && /* @__PURE__ */ jsx34("span", { className: "text-[0.7rem] text-slate-400", children: "\u25C6" }),
                    block.type === "heading_3" && /* @__PURE__ */ jsx34("span", { className: "text-[0.6rem] text-slate-400", children: "\u25CB" }),
                    /* @__PURE__ */ jsx34("span", { className: "block", children: block[`${block.type}`].rich_text.map(
                      (richText, index) => /* @__PURE__ */ jsx34(
                        BlockRichText,
                        {
                          richText,

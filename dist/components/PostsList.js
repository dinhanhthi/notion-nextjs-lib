...
function BlockCode(props) {
  ...
  return /* @__PURE__ */ jsxs14("div", { className: cn17(className, "group"), children: [
    /* @__PURE__ */ jsxs14("div", { className: `language-${formatCodeLang(language)} syntax-highlighter relative text-[18px]`, children: [
      /* @__PURE__ */ jsx27(
        SyntaxHighlighter,
        {
      ...
      /* @__PURE__ */ jsx27(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx27(CopyToClipboard, { text: getJoinedRichText(block?.code?.rich_text), onCopy: onSuccess, children: /* @__PURE__ */ jsxs14("button", { children: [
            !copied && /* @__PURE__ */ jsx27(RxCopy, { className: "text-lg text-slate-300 hover:text-slate-600" }),
